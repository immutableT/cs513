...
# @OUT FullJoin @URI file:./data/FullJoin.csv
...
def pre_process():
    ...
    # @OUT datetime_menu_dish_df @OUT datetime_menu_item_df @OUT datetime_menu_page_df @OUT datetime_menu_df
    ...
    # @OUT drop_menu_dish_df @OUT drop_menu_item_df @OUT drop_menu_page_df @OUT drop_menu_df
    ...
    # @OUT clean_menu_dish_df @OUT clean_menu_item_df @OUT clean_menu_page_df @OUT clean_menu_df
    ...
    # @BEGIN Join
    # @IN clean_menu_dish_df @IN clean_menu_item_df @IN clean_menu_page_df @IN clean_menu_df
    # @OUT full_join_df
    joiner = Joiner(
        dish_df=dish_df,
